...
import { nft1, nft2, nft3, nft4 ,user1} from "../images";
                ...
                <div className={Style.bigNFTSlider_box}>
                    <div className={Style.bigNFTSlider_box_left}>
                        ...
                        <div className={Style.bigNFTSlider_box_left_bidding}>
                            <div className={Style.bigNFTSlider_box_left_bidding_box}> <small>Current Bid</small>
                                <p>{sliderData[idNumber].price} <span>$,221,21</span></p>
                            </div>

                            <p className={Style.bigNFTSlider_box_left_bidding_box_auction}>
                                <MdTimer
                                    className={Style.bigNFTSlider_box_left_bidding_box_item}
                                />
                                <span>Auction</span>
                            </p>
                            ...
                            <div className={Style.bigNFTSlider_box_left_button}>
                                <button btnName="Place" handleClick={() => { }} >buy</button>
                                <button btnName="View" handleClick={() => { }} >details</button>
                            </div>
                        </div>

                        <div className={Style.bigNFTSlider_box_left_sliderBtn}>
                            <TbArrowBigLeftLines
                            className={Style.bigNFTSlider_box_left_sliderBtn_icon} onClick={() => dec()}/>
                            <TbArrowBigRightLines
                            className={Style.bigNFTSlider_box_left_sliderBtn_icon} onClick={() => inc()}/>
                        </div>
                    </div>
